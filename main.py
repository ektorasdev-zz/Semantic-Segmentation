...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    output_7 = tf.layers.conv2d_transpose(conv_1x1_7, num_classes, 4, strides=(2, 2), padding='same',
                                          kernel_initializer=tf.random_normal_initializer(stddev=0.01),
                                          kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
    ...
    skip_7 = tf.add(output_7, conv_1x1_4)
    output_4 = tf.layers.conv2d_transpose(skip_7, num_classes, 4, strides=(2, 2), padding='same',
                                          kernel_initializer=tf.random_normal_initializer(stddev=0.01),
                                          kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
    ...
    skip_4 = tf.add(output_4, conv_1x1_3)
    output_3 = tf.layers.conv2d_transpose(skip_4, num_classes, 16, strides=(8, 8), padding='same',
                                          kernel_initializer=tf.random_normal_initializer(stddev=0.01),
                                          kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
    return output_3
